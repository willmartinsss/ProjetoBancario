...
export function main() {
  ...
  let opcao, number, agency, type, amount, limit, birthday: number;
  let holder: string;
  const typeAccounts = ["Conta Corrente", "Conta poupanca"];

  console.log("\nCriar Contas\n");
  let cc1: CurrentAccount = new CurrentAccount(
    accounts.generatorNumber(),
    123,
    1,
    "João da Silva",
    1000,
  ...
  let cc2: CurrentAccount = new CurrentAccount(
    accounts.generatorNumber(),
    124,
    1,
    "Maria da Silva",
  ...
  let cp1: SavingAccount = new SavingAccount(
    accounts.generatorNumber(),
    125,
    2,
    "Mariana dos Santos",
  ...
  let cp2: SavingAccount = new SavingAccount(
    accounts.generatorNumber(),
    125,
    2,
    "Juliana Ramos",
      ...
      case 1:
        ...
        switch (type) {
          case 1:
            ...
            accounts.register(
              new CurrentAccount(
                accounts.generatorNumber(), agency, type, holder, amount, limit));
            break;
          case 2:
            ...
            accounts.register(
              new SavingAccount(
                accounts.generatorNumber(), agency, type, holder, amount, birthday));
            break;
        }
        keyPress();
        break;
